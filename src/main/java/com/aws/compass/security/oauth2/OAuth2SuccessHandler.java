...
public class OAuth2SuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        if (user == null) { // 소셜 로그인 돼있는 유저가 없다면 -> 새로 회원가입
            ...
            response.sendRedirect("http://compass-cheawon.s3-website.ap-northeast-2.amazonaws.com/auth/detail/signup" +
                    "?oauth2Id=" + oauth2Id +
                    "&provider=" + provider);
            return;
        }
        ...
        response.sendRedirect("http://compass-cheawon.s3-website.ap-northeast-2.amazonaws.com/auth/oauth2/signin" +  // client로 token을 보낸다
